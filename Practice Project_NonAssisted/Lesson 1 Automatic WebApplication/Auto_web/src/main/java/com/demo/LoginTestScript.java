...
public class LoginTestScript {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		addDetailsToLoginForm(driver, "Megantha", "megantha@gmail.com", "Megantha");// get login data
		addDetailToRegisterForm(driver, "megantha@gmail.com", "Megantha", "Megantha");// get register data
